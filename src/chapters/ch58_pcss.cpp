...
static const std::vector<SceneVertex> SCENE = {
    // 地面（阴影接收面）
    {{-5, -0.5f, -5}, {0, 1, 0}, {0.5f, 0.48f, 0.4f}},
    {{5, -0.5f, -5}, {0, 1, 0}, {0.5f, 0.48f, 0.4f}},
    {{5, -0.5f, 5}, {0, 1, 0}, {0.5f, 0.48f, 0.4f}},
    {{-5, -0.5f, -5}, {0, 1, 0}, {0.5f, 0.48f, 0.4f}},
    {{5, -0.5f, 5}, {0, 1, 0}, {0.5f, 0.48f, 0.4f}},
    {{-5, -0.5f, 5}, {0, 1, 0}, {0.5f, 0.48f, 0.4f}},
    // 立柱（阴影投射者）
    {{-0.25f, -0.5f, -0.25f}, {0, 0, -1}, {0.7f, 0.65f, 0.6f}},
    {{0.25f, -0.5f, -0.25f}, {0, 0, -1}, {0.7f, 0.65f, 0.6f}},
    {{0.25f, 3.0f, -0.25f}, {0, 0, -1}, {0.7f, 0.65f, 0.6f}},
    {{-0.25f, -0.5f, -0.25f}, {0, 0, -1}, {0.7f, 0.65f, 0.6f}},
    {{0.25f, 3.0f, -0.25f}, {0, 0, -1}, {0.7f, 0.65f, 0.6f}},
    {{-0.25f, 3.0f, -0.25f}, {0, 0, -1}, {0.7f, 0.65f, 0.6f}},
    // 低矮方块（离地面近，阴影边缘锐利）
    {{-3, -0.5f, -1}, {0, 0, -1}, {0.4f, 0.6f, 0.8f}},
    {{-2, -0.5f, -1}, {0, 0, -1}, {0.4f, 0.6f, 0.8f}},
    {{-2, 0.5f, -1}, {0, 0, -1}, {0.4f, 0.6f, 0.8f}},
    {{-3, -0.5f, -1}, {0, 0, -1}, {0.4f, 0.6f, 0.8f}},
    {{-2, 0.5f, -1}, {0, 0, -1}, {0.4f, 0.6f, 0.8f}},
    {{-3, 0.5f, -1}, {0, 0, -1}, {0.4f, 0.6f, 0.8f}},
    // 高台（离地面远，阴影边缘柔和）
    {{2, -0.5f, -1}, {0, 0, -1}, {0.8f, 0.5f, 0.3f}},
    {{3, -0.5f, -1}, {0, 0, -1}, {0.8f, 0.5f, 0.3f}},
    {{3, 2.5f, -1}, {0, 0, -1}, {0.8f, 0.5f, 0.3f}},
    {{2, -0.5f, -1}, {0, 0, -1}, {0.8f, 0.5f, 0.3f}},
    {{3, 2.5f, -1}, {0, 0, -1}, {0.8f, 0.5f, 0.3f}},
    {{2, 2.5f, -1}, {0, 0, -1}, {0.8f, 0.5f, 0.3f}},
};
  ...
  private:
    ...
    void createRenderPasses() {
        // Shadow RP
        {
            ...
            a.format = findDepthFormat(physDev_);
    ...
    void createPipelines() {
        // Shadow pipeline（depth-only, no frag）
        {
            ...
            gci.pColorBlendState = &noCbs;
            gci.pDynamicState = &dyns;
            gci.layout = shadowLayout_;
            gci.renderPass = shadowRP_;
    ...
    void drawFrame() {
        ...
        clears[0].color.float32[0] = 0.6f;
        clears[0].color.float32[1] = 0.65f;
        clears[0].color.float32[2] = 0.75f;
