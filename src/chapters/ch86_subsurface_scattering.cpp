...
protected:
    void onInit() override { bgColor_ = {0.06f, 0.04f, 0.05f}; }
    ...
    void buildUi() override
    {
        ...
        if (ImGui::BeginTabBar("SssTabs")) {
            ...
            if (ImGui::BeginTabItem("Separable Blur")) {
                ...
                ImGui::Separator();
                ImGui::TextWrapped(
                    "Pass 1: 渲染 Diffuse + Thickness（厚度图）\n"
            ...
            if (ImGui::BeginTabItem("材质预设")) {
                ...
                ImGui::Text("  散射 RGB : (%.2f, %.2f, %.2f)",
                    scatterColor_.x, scatterColor_.y, scatterColor_.z);
            ...
            if (ImGui::BeginTabItem("Diffusion Profile")) {
                ...
                ImGui::Separator();
                ImGui::TextWrapped(
                    "预计算 RGB 各自的 1D 扩散核（存储为 1D Texture）：\n"
                    "  · 皮肤：R 散射远，G 中等，B 近\n"
...
private:
    ...
    {
        switch (preset) {
        case 0: scatterColor_ = {1.0f, 0.7f, 0.6f}; scatterDist_ = 3.0f;  wrapAmount_ = 0.5f; break;
        case 1: scatterColor_ = {1.0f, 0.95f, 0.8f}; scatterDist_ = 8.0f; wrapAmount_ = 0.7f; break;
        case 2: scatterColor_ = {0.7f, 0.9f, 0.7f}; scatterDist_ = 2.0f; wrapAmount_ = 0.3f; break;
        case 3: scatterColor_ = {0.5f, 0.8f, 0.3f}; scatterDist_ = 1.5f; wrapAmount_ = 0.6f; break;
        case 4: scatterColor_ = {0.95f, 0.95f, 0.9f}; scatterDist_ = 12.0f; wrapAmount_ = 0.8f; break;
        default: break;
        }
    }
};
