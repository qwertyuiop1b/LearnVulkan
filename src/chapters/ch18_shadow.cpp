...
static const std::vector<Vertex> VERTICES = {
    ...
    {{-3, -0.5f, 3}, {0, 1, 0}, {0.5f, 0.5f, 0.5f}},
    // 立柱1（红）
    {{-0.2f, -0.5f, -0.2f}, {0, 0, 1}, {1, 0.2f, 0.2f}},
    {{0.2f, -0.5f, -0.2f}, {0, 0, 1}, {1, 0.2f, 0.2f}},
    {{0.2f, 1.5f, -0.2f}, {0, 0, 1}, {1, 0.2f, 0.2f}},
    {{-0.2f, -0.5f, -0.2f}, {0, 0, 1}, {1, 0.2f, 0.2f}},
    {{0.2f, 1.5f, -0.2f}, {0, 0, 1}, {1, 0.2f, 0.2f}},
    {{-0.2f, 1.5f, -0.2f}, {0, 0, 1}, {1, 0.2f, 0.2f}},
    // 立柱2（绿，偏左）
    {{-1.5f, -0.5f, 0.3f}, {1, 0, 0}, {0.2f, 1, 0.2f}},
    {{-1.1f, -0.5f, 0.3f}, {1, 0, 0}, {0.2f, 1, 0.2f}},
    {{-1.1f, 2.0f, 0.3f}, {1, 0, 0}, {0.2f, 1, 0.2f}},
    {{-1.5f, -0.5f, 0.3f}, {1, 0, 0}, {0.2f, 1, 0.2f}},
    {{-1.1f, 2.0f, 0.3f}, {1, 0, 0}, {0.2f, 1, 0.2f}},
    {{-1.5f, 2.0f, 0.3f}, {1, 0, 0}, {0.2f, 1, 0.2f}},
};
  ...
  private:
    ...
    void initWindow() {
        ...
        glfwSetFramebufferSizeCallback(window_, [](GLFWwindow* w, int, int) {
            reinterpret_cast<Ch18App*>(glfwGetWindowUserPointer(w))->resized_ = true;
        });
    }
    ...
    void createShadowResources() {
        ...
        imgCI.usage =
            VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT | VK_IMAGE_USAGE_SAMPLED_BIT; // 作为纹理供场景Pass采样
    ...
    void createShadowRenderPass() {
        ...
        fbCI.width = SHADOW_DIM;
        fbCI.height = SHADOW_DIM;
        fbCI.layers = 1;
    ...
    void createShadowPipeline() {
        ...
        vs.viewportCount = 1;
        vs.pViewports = &shadowVP;
        vs.scissorCount = 1;
        vs.pScissors = &shadowSC;
    ...
    glm::mat4 getLightSpaceMatrix() {
        glm::mat4 lightView = glm::lookAt(-lightDir_ * 5.0f,  // 光源位置
    ...
    void recordCommandBuffer(VkCommandBuffer cmd, uint32_t imageIndex) {
        ...
        // ════════════════════════════════════════════════════════════════════
        {
            ...
            vkCmdPushConstants(cmd, shadowPipelineLayout_, VK_SHADER_STAGE_VERTEX_BIT, 0, sizeof(pc), &pc);
        ...
        // ════════════════════════════════════════════════════════════════════
        {
            ...
            rp.framebuffer = sceneFramebuffers_[imageIndex];
    ...
    void createSceneUBOs() {
        VkDeviceSize sz = sizeof(SceneUBO);
        ...
        for (int i = 0; i < MAX_FRAMES; ++i) {
            createBuffer(sz,
                         ...
                         sceneUBOs_[i],
                         sceneUBOMemories_[i]);
            vkMapMemory(device_, sceneUBOMemories_[i], 0, sz, 0, &sceneUBOMapped_[i]);
        }
    }
    ...
    void createScenePipeline() {
        ...
        pi.layout = scenePipelineLayout_;
