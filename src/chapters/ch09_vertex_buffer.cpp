...
private:
    ...
    void initWindow()
    {
        ...
        glfwSetFramebufferSizeCallback(window_,
            [](GLFWwindow* w, int, int) { reinterpret_cast<Ch09App*>(glfwGetWindowUserPointer(w))->resized_ = true; });
    }
    ...
    void createVertexBuffer()
    {
        ...
        std::cout << "✅ 顶点缓冲已创建（" << VERTICES.size() << " 个顶点，"
                  << bufferSize << " 字节，DEVICE_LOCAL）\n";
    }
    ...
    void drawFrame()
    {
        ...
        pi.swapchainCount = 1; pi.pSwapchains = swaps; pi.pImageIndices = &imageIndex;
