    ...
    void buildUi() override {
        ...
        if (ImGui::BeginTabBar("CmdTabs")) {
            ...
            if (ImGui::BeginTabItem("RAII 录制")) {
                ...
                ImGui::Separator();
                ImGui::TextWrapped("// 传统写法（容易忘记 End）：\n"
            ...
            if (ImGui::BeginTabItem("BarrierBatch")) {
                ...
                ImGui::Separator();
                ImGui::TextWrapped("// 传统写法：每个 barrier 单独调用 vkCmdPipelineBarrier（效率低）\n"
            ...
            if (ImGui::BeginTabItem("DrawCallBatch 排序")) {
                ...
                ImGui::TextColored(ImVec4(1, 1, 0.3f, 1),
                                   "节省管线切换：%d 次（%.0f%% 减少）",
                                   unsortedSwitches_ - sortedSwitches_,
                                   saving);

                ImGui::Separator();
                ImGui::TextWrapped("// DrawKey 编码（64 bit）：\n"
