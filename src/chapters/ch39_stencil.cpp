...
class Ch39App {
  ...
  private:
    ...
    void initWindow() {
        ...
        window_ = glfwCreateWindow(WIDTH, HEIGHT, "Ch39 - 模板缓冲描边（Stencil Outline）", nullptr, nullptr);
    ...
    VkPipeline buildPipeline(VkPipelineColorBlendAttachmentState cba, VkPipelineDepthStencilStateCreateInfo ds) {
    ...
    void createGraphicsPipelines() {
        ...
        fillBlend.colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT;
    ...
    void createUniformBuffers() {
        ...
        for (int i = 0; i < MAX_FRAMES; ++i) {
            ...
            createBuffer(physicalDevice_,
                         ...
                         VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT,
                         VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT,
                         outlineUniformBuffers_[i],
                         outlineUniformMemory_[i]);
            vkMapMemory(device_, outlineUniformMemory_[i], 0, size, 0, &outlineUniformMapped_[i]);
        }
    }

    void createDescriptorPool() {
        VkDescriptorPoolSize poolSize{VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, static_cast<uint32_t>(MAX_FRAMES * 2)};
    ...
    UniformBufferObject makeUbo(float scale) {
        ...
        ubo.model =
            glm::scale(glm::rotate(glm::mat4(1.0f), t * glm::radians(45.0f), glm::vec3(0, 1, 0)), glm::vec3(scale));
    ...
    void recordCommandBuffer(VkCommandBuffer cmd, uint32_t imageIndex) {
        ...
        vkCmdBindDescriptorSets(cmd,
                                ...
                                0,
                                1,
                                &outlineDescriptorSets_[currentFrame_],
                                0,
                                nullptr);
        vkCmdDraw(cmd, vertexCount, 1, 0, 0);
