    ...
    void buildUi() override {
        ...
        if (ImGui::BeginTabBar("WeatherTabs")) {
            ...
            if (ImGui::BeginTabItem("粒子与风")) {
                ...
                ImGui::Text("  gravity       = (%.1f, %.1f, %.1f)", gravity_.x, gravity_.y, gravity_.z);
                ImGui::EndTabItem();
            }
            ...
            if (ImGui::BeginTabItem("集成架构")) {
                ImGui::TextWrapped("class WeatherSystem {\n"
