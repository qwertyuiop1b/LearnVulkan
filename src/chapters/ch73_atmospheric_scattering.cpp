    ...
    void buildUi() override
    {
        ...
        if (ImGui::BeginTabBar("AtmoTabs")) {
            ...
            if (ImGui::BeginTabItem("颜色预测")) {
                ...
                ImGui::ColorButton("天顶##col", ImVec4(zenithColor_.x, zenithColor_.y, zenithColor_.z, 1),
                    ImGuiColorEditFlags_NoTooltip, ImVec2(200, 40));
                ImGui::SameLine();
                ImGui::Text("R=%.2f G=%.2f B=%.2f", zenithColor_.x, zenithColor_.y, zenithColor_.z);

                ImGui::Spacing();
                ImGui::TextColored(ImVec4(1,0.8f,0.5f,1), "地平线颜色（水平看）：");
                ImGui::ColorButton("地平线##col", ImVec4(horizonColor_.x, horizonColor_.y, horizonColor_.z, 1),
                    ImGuiColorEditFlags_NoTooltip, ImVec2(200, 40));
                ImGui::SameLine();
                ...
                ImGui::ColorButton("太阳##col", ImVec4(sunColor_.x, sunColor_.y, sunColor_.z, 1),
                    ImGuiColorEditFlags_NoTooltip, ImVec2(200, 40));
                ImGui::SameLine();
