...
private:
    ...
    void createColorResources()
    {
        ...
        ci.image    = colorImage_; ci.viewType = VK_IMAGE_VIEW_TYPE_2D;
    ...
    void createGraphicsPipeline()
    {
        ...
        pi.pDepthStencilState = &ds; pi.pColorBlendState = &cb;
    ...
    void updateUniformBuffer(uint32_t frame)
    {
        ...
        ubo.model = glm::rotate(glm::mat4(1.0f),
            t * glm::radians(15.0f), glm::vec3(0, 0, 1));
        ubo.view  = glm::lookAt(
                     ...
                     VkImage& img, VkDeviceMemory& mem)
    {
        ...
        ci.extent        = {w, h, 1};
        ci.mipLevels     = mips; ci.arrayLayers = 1;
    ...
    void createDescriptorSetLayout()
    {
        ...
        ci.bindingCount = 1; ci.pBindings = &ub;
    ...
    void recreateSwapchain()
    {
        ...
        createSwapchain(); createImageViews();
        createColorResources(); createDepthResources(); createFramebuffers();
    }
    void cleanup()
    {
        vkDestroyImageView(device_, colorImageView_, nullptr);
